...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='donor.asia,www.donor.asia,localhost,127.0.0.1', cast=Csv())
...
SITE_URL = config('SITE_URL', default='https://donor.asia')

CSRF_TRUSTED_ORIGINS = [
    'http://localhost',
    'http://127.0.0.1',
    'https://donor.asia',
    'https://www.donor.asia',
]